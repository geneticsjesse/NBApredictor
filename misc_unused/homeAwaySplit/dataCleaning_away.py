...
gamedat_cleaned = gamedat[['season_id', 'team_id_home', 'team_abbreviation_home', 'team_name_home', 'game_id', 'game_date', 'matchup_home', 'wl_home', 'team_id_away', 'team_abbreviation_away', 'team_name_away', 'game_yearEnd']].rename(columns={'team_name_away': 'Team'})
...
# Adding new column that represents home/away status (home = 1, away = 0)
merged_df['status'] = 0

# Writing to csv
merged_df.to_csv('merged_df_away.csv', index=False)
