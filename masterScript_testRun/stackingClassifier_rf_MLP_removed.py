...
fig1.savefig(f"./hyperparameterOptimization/modelComparison_beforeOptimization_rf_MLP_removed.png")
plt.close(fig1)
#plt.show()
...
fig2.savefig(f"./hyperparameterOptimization/modelComparison_afterOptimization_rf_MLP_removed.png")
plt.close(fig2)
#plt.show()
...
for name, model in optimized_models:
    ...
    plt.savefig(f'confusionMatrices/{name}_ConfusionMatrix_rf_MLP_removed.png')